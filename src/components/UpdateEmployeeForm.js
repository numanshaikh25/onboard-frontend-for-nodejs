...
function UpdateEmployeeForm() {
  ...
  useEffect(() => {
    ...
    async function fetchEmployee() {
      const { data } = await axios.get(
        `https://onboard-backend-nodejs.herokuapp.com/api/employee/getemployee/${id}`,
        config
      );
  ...
  const submitDetailsHandler = (e) => {
    ...
    axios
      .put(
        `https://onboard-backend-nodejs.herokuapp.com/api/employee/updateemployeedetails/${id}`,
        formData,
        config
      )
      .then((res) => {
  ...
  const submitDocumentsHandler = (e) => {
    ...
    axios
      .put(
        `https://onboard-backend-nodejs.herokuapp.com/api/employee/updateemployeedocuments/${id}/`,
        formData,
        config
      )
      .then((res) => {
      ...
      .catch((err) => {
        setLoadingdocuments(false);
        // console.log(err.response.data.message);
        setErrormessagedocuments(err.response.data.message);
